INSERT INTO `member` (`id`, `first_name`, `last_name`, `email`, `password`, `active`, `admin`, `phone`, `bike`, `registration_date`, `created_on`, `modified_on`) VALUES
...
INSERT INTO `track` (`id`, `name`, `distance`, `lap_record`, `website`, `latitude`, `longitude`) VALUES
...
INSERT INTO `event` (`id`, `title`, `description`, `start_date`, `end_date`, `track_id`, `organizer`, `price`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
...
INSERT INTO `gallery` (`id`, `title`, `description`, `created_on`, `modified_on`) VALUES
...
INSERT INTO `photo` (`id`, `title`, `description`, `link`, `created_on`, `modified_on`) VALUES
...
INSERT INTO `event_member` (`id`, `event_id`, `member_id`, `created_on`) VALUES
(1, 3, 2, '2018-06-01 09:35:07'),
(2, 1, 1, '2018-02-08 14:30:29'),
(3, 3, 1, '2018-04-20 17:14:27'),
(4, 2, 1, '2017-11-18 10:42:55');

INSERT INTO `liked_news` (`id`, `news_id`, `member_id`, `created_on`) VALUES
